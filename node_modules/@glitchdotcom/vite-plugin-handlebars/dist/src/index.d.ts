...
export default function handlebars({ reloadOnPartialChange, settingsFile, compileOptions, runtimeOptions, partialDirectory, helpers, }: HandlebarsPluginConfig): VitePlugin;
export {};
